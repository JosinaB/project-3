...
if account == "Donor":
    ...
    if st.button("donate now"):
        ...
        st.balloons()
if account == "Buyer":
    st.multiselect('pick the art article being auction', ['milk', 'apples', 'potatoes'])
   # art_gallery = https://gateway.pinata.cloud/ipfs/{}


    address = st.text_input('Enter account address')
    if st.button("Place bid"):
        bid = second_contract.functions.bid(address)
