...
def load_contract():
    ...
    contract_address = Web3.toChecksumAddress(0x45af12c9c96a893d10409ef48f4108c040cffdf4)
...
def load_contract():
    ...
    # Set the contract address (this is the address of the deployed contract)
    contract_address = Web3.toChecksumAddress(0x55ebde56fd89caddce30e1a152f0eab29ce74278)
